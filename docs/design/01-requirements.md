...
| :--- | :--- | :--- |
| 상품 미존재 | `404 NOT FOUND` | `상품이 존재하지 않습니다. productId: {productId}` |
| 중복된 요청 | `409 CONFLICT` | `이미 좋아요 처리 된 상품 입니다. productId: {productId}` |
...
| :--- | :--- | :--- |
| 상품 미존재 | `404 NOT FOUND` | `상품이 존재하지 않습니다. productId: {productId}` |
| 상품 재고 부족 | `404 NOT FOUND` | `상품 재고가 부족합니다. productId: {productId}` |
| 비로그인 사용자 | `401 UNAUTHORIZED` | `로그인 한 사용자가 아닙니다. X-USER-ID: {X-USER-ID}` |
...
| 오류 상황 | HTTP 상태 코드 | 에러 메시지 |
| :--- | :--- | :--- |
| 주문 상세내역 미존재 | `404 NOT FOUND` | `주문이 존재 하지 않습니다. orderId: {orderId}` |
| 비로그인 사용자 | `401 UNAUTHORIZED` | `로그인 한 사용자가 아닙니다. X-USER-ID: {X-USER-ID}` |
